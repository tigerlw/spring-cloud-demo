...
@SpringBootTest(classes = ComsumerFeignApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
public class ComsumerFeignApplicationTests {
	   ...
	   @BeforeClass
	    ...
	    @Test
	    public void ucloudlinkAddTest() throws InterruptedException {
	        ...
	        then(response.getBody()).contains("40");
	    }
